    ...
    , m_virtualMachine(virtualMachine)
{
	...
	m_OnFunctionDblClickConnection = m_functionsView->OnFunctionDblClick.Connect(std::bind(&DebuggerWindow::OnFunctionsViewFunctionDblClick, this, std::placeholders::_1));
	m_OnFunctionsStateChangeConnection = m_functionsView->OnFunctionsStateChange.Connect(std::bind(&DebuggerWindow::OnFunctionsViewFunctionsStateChange, this));
